  ...
  import styles from "./ResumeTemplates3.module.css";
  import {
    FaGithub,
    FaLinkedin,
    FaPaperclip,
  ...
  const ResumeTemplates3 = forwardRef((props, ref) => {
    ...
    const swapSourceTarget = (source, target) => {
      ...
      let sourceRowIndex = tempColumns.findIndex((item) => item === source);
  
      //for target also
      let targetRowIndex = tempColumns.findIndex((item) => item === target);
  
      const tempSource = tempColumns[sourceRowIndex];
      tempColumns[sourceRowIndex] = tempColumns[targetRowIndex];
      tempColumns[targetRowIndex] = tempSource;
